...
export class ComponentTransformerService {
  ...
  private getComponentStructure(componentType: string, variationNumber: number) {
    const classMaps = this.getGenericClassMaps(componentType);
  ...
  /**
   * Get generic responsive class maps that work for any component type
   */
  private getGenericClassMaps(componentType: string): ClassMaps {
    const baseClasses = {
      container: {
    ...
    switch (componentType) {
      ...
      case 'cta':
        return {
          ...
          card: {
            mobile: "relative max-w-md mx-auto bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-6",
            tablet: "relative max-w-lg mx-auto bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8",
            desktop: "relative max-w-xl mx-auto bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-10",
            responsive: "relative max-w-md mx-auto bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-6 md:max-w-lg md:rounded-3xl md:p-8 lg:max-w-xl lg:rounded-3xl lg:p-10"
          },
          ctaButton: {
