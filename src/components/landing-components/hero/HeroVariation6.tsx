...
const HeroVariation6: React.FC<HeroVariation6Props> = ({
  ...
  const professionalImageClassMap = {
    mobile: 'h-[400px]',
    tablet: 'h-[550px]',
    desktop: 'h-[600px]',
    responsive: 'h-[400px] md:h-[550px] lg:h-[600px]'
  };
  const contentLeftClassMap = {
  ...
  const professionalNameClassMap = {
    mobile: 'text-lg',
    tablet: 'text-xl',
    desktop: 'text-xl',
